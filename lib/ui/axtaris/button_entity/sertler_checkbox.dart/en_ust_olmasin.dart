...
class EnUstOlmasin extends StatefulWidget {
  ...
  @override
  State<EnUstOlmasin> createState() => _EnUstOlmasinState();
}

class _EnUstOlmasinState extends State<EnUstOlmasin> {
  @override
        ...
        child: Row(
          ...
          children: [
            ...
            Checkbox(
              ...
              onChanged: (value) {
                setState(() {
                  if (queryParameters.noTopFloor == 'false') {
                    queryParameters.noTopFloor = 'true';
                  } else {
                    queryParameters.noTopFloor = 'false';
                  }
