...
class RangeSliderForPrice extends StatefulWidget {
  ...
  @override
  State<RangeSliderForPrice> createState() => _RangeSliderForPriceState();
}

class _RangeSliderForPriceState extends State<RangeSliderForPrice> {
  ...
  Widget build(BuildContext context) {
    ...
    return RangeSlider(
        ...
        onChangeEnd: (value) {
          setState(() {
            queryParameters.minPrice = value.start.toInt().toString();
            queryParameters.maxPrice = value.end.toInt().toString();
          });
